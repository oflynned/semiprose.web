        ...
        <div className={"flex flex-[2] items-center m-8"}>
          <div className={"flex flex-col gap-4 max-w-screen-md"}>
            ...
            <p className={"leading-relaxed"}>
              ...
              in closed beta, but you can join the waitlist to get early access.
            </p>
            ...
            <ul className={"flex flex-col gap-4"}>
              ...
              <li>
                ...
                <p className={"leading-relaxed"}>
                  ...
                  fostering a supportive and interactive community of passionate
                  readers and writers.
                </p>
              </li>
              <li>
                ...
                <p className={"leading-relaxed"}>
                  ...
                  personalized insights into your writing style, allowing you to
                  pinpoint strengths, identify areas for improvement, and
              ...
              <li>
                ...
                <p className={"leading-relaxed"}>
                  ...
                  global platform that transcends boundaries, providing you with
                  the opportunity to collaborate, learn, and share cultural
